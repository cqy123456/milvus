...
InitMmapManager(CMmapConfig c_mmap_config) {
    try {
        ...
        mmap_config.scalar_field_enable_mmap = c_mmap_config.scalar_field_enable_mmap;
        mmap_config.vector_index_enable_mmap =
            c_mmap_config.vector_index_enable_mmap;
        mmap_config.vector_field_enable_mmap = c_mmap_config.vector_field_enable_mmap;
