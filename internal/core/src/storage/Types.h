...
struct MmapConfig {
    ...
    ToString() const {
        ...
        ss << "[cache_read_ahead_policy=" << cache_read_ahead_policy
           ...
           << ", scalar_field_enable_mmap=" << std::boolalpha << scalar_field_enable_mmap  
           << ", vector_index_enable_mmap=" << std::boolalpha << vector_index_enable_mmap 
           << ", vector_field_enable_mmap=" << std::boolalpha << vector_field_enable_mmap  
           << "]";
        return ss.str();
    }
};
